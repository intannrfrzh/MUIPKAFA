        ...
        <div class="content">
            <div class="container">
                ...
                <div class="form-group">
                    ...
                    <textarea placeholder="purpose of the activity" id="A_Activity_details" name="A_Activity_details" readonly>{{ $activity->A_Activity_details }}</textarea>
                </div>
                <div class="form-group">
                    <label for="A_Activity_datestart">START DATE:</label>
                    <input type="date" id="A_Activity_datestart" name="A_Activity_datestart" value="{{ $activity->A_Activity_datestart }}" readonly>
                </div>
                <div class="form-group">
                    <label for="A_Activity_dateend">END DATE:</label>
                    <input type="date" id="A_Activity_dateend" name="A_Activity_dateend" value="{{ $activity->A_Activity_dateend }}" readonly>
                </div>
                <div class="form-group">
                    <label for="A_Activity_timestart">START TIME:</label>
                    <input type="time" id="A_Activity_timestart" name="A_Activity_timestart" value="{{ $activity->A_Activity_timestart }}" readonly>
                </div>
                <div class="form-group">
                    <label for="A_Activity_timeend">END TIME:</label>
                    <input type="time" id="A_Activity_timeend" name="A_Activity_timeend" value="{{ $activity->A_Activity_timeend }}" readonly>
                </div>
                <div class="form-group">
